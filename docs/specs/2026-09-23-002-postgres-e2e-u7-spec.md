...
- **L1:** Vitest teardown removes only the Compose project it created; each lease cleanup unschedules its job and returns the database even after a scenario failure.
