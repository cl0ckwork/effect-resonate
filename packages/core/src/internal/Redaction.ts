...
export const protocolError = (issue: DurableProtocolError["issue"]): DurableProtocolError =>
  new DurableProtocolError({ issue })
...
export const durableValueError = (location: InvalidDurableValue["location"]): InvalidDurableValue =>
