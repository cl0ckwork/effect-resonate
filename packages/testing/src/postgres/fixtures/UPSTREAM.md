...
The image derives from the pinned official Postgres 16 Bookworm image and installs `postgresql-16-cron`; the IntegreSQL image is pinned by digest in `docker-compose.yml`.
